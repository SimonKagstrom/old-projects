...
# endif /* SDCC */
#else
extern void fe_draw_bitmap(const uint8_t *p_bitmap, uint8_t x, uint8_t y, uint8_t inverted);
#endif /* FE_REX_OPT */
 ...
 */
extern void fe_add_event(uint8_t x, uint8_t y, uint8_t w, uint8_t h, int16_t id);
 ...
 * @todo This function is not yet implemented.
 */
extern void fe_del_event(int16_t id);
